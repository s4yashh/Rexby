  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t border-gray-200">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        {/* Left - Profile Card */}
        <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-12">
        ...
        {/* Right - Bio */}
        <div>
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Ása Steinars</h2>
          ...
          <div className="flex gap-4 mb-8">
            ...
            <a href="#" className="text-gray-600 hover:text-gray-900">Storefront</a>
          </div>
